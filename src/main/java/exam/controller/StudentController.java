...
public class StudentController {
    ...
    public String queryStudents(@RequestParam(name = "pageNum", required = false, defaultValue = "1")
        ...
        List<Student> studentList = studentService.selectStudent(pageNum, pageSize,queryMap);
        ...
        {
            model.addAttribute("warnStr","没有数据!");
        }
        else {
...
//        model.addAttribute("name","测试");
    ...
    @GetMapping("/getStudentMajor")
    @ResponseBody
    public List<StudentMajor> departmentList(){
        return studentService.queryStudentMajor();
    }
    ...
    public boolean add(Student student){
        ...
        student.setRegistrantDate(new Date());
       ...
       return studentService.insertStu(student,uploadPath)>0?true:false;
